...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CSDP_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9ce75daa-2788-5e2c-ba1d-cf8c48367b27"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CSDP", artifacts_toml) for e in artifacts["CSDP"]]
...
if best_platform === nothing
    @debug("Unable to load CSDP; unsupported platform $(triplet(platform_key_abi()))")
else
